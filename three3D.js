...
//http://echarts.baidu.com/demo.html#geo-lines
    ...
    mapCanvas2 = document.createElement( 'canvas' );
    mapCanvas2.width = mapSize.width;
    mapCanvas2.height = mapSize.height;

    mapTexture2 = new THREE.Texture( mapCanvas2 );

    map2 = new maptalks.Map(container,{
        center:[110.0052,38.04231],
        zoom:3.8,
        minZoom:3.8,
        maxZoom:3.8,
        zoomInCenter:true,
    ...
    map = new maptalks.Map(mapCanvas2,{
